                    ...
                    mMusicDao.findOneById(1).subscribe(musicInDb -> {
                        ...
                        mCrossRefDao.saveOne(crossRef).subscribe(aLong3 -> {
                            mCrossRefDao.findAllMusicInOneMusicList(aLong.intValue())
                                    .subscribe(new FlowableSubscriber<List<MusicListAndMusicCrossRef>>() {
                                        @Override
                                        ...
                                        @Override
                                        public void onNext(List<MusicListAndMusicCrossRef> list) {
                                            Assert.assertEquals(1, list.size());
                                            Log.i(TAG, "get all success, and list is :" + list);
                                        }
